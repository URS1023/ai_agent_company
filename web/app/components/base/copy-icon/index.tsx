      ...
      <TooltipTrigger
        render={
          <button
            ...
            className={cn(
              'mx-1 inline-flex size-3.5 cursor-pointer border-0 bg-transparent p-0 text-text-tertiary outline-hidden focus-visible:ring-2 focus-visible:ring-state-accent-solid',
              className,
            )}
            onClick={handleCopy}
            onMouseLeave={reset}
